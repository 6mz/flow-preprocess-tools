...
name_opts['target'] = '../data/ds_v2/TEST5_1'
name_opts['sdir'] = ['show', 'show', 'flow', 'flow', 'show', 'show',
                     'show', 'flow', 'flow', 'show', 'show']
name_opts['suffix'] = ['A', 'B', 'gtAB', 'gtBA', 'gtAB_viz', 'gtBA_viz',
                       'C', 'gtBC', 'gtCB', 'gtBC_viz', 'gtCB_viz']
name_opts['ext'] = ['png', 'png', 'flo', 'flo', 'jpg', 'jpg',
                    'png', 'flo', 'flo', 'jpg', 'jpg']
...
for i, name in enumerate(nm):
    ...
    # 生成、保存
    mainboard.Gen()
    name_dict = dict(zip(['imB', 'flowAB', 'flowBA',
                          'flowAB_viz', 'flowBA_viz'],
                         name[name_front: name_front+5]))
    name_front += 5
