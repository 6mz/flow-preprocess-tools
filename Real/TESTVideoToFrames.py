...
##### 测试
pathIn = '../data/Real/test.mp4'
VideoToFrames(pathIn, only_output_video_info = True)

pathOut = '../data/Real/frames1/'
VideoToFrames(pathIn, pathOut)

pathOut = '../data/Real/frames2'
VideoToFrames(pathIn, pathOut, extract_time_points=(1, 2, 5))

pathOut = '../data/Real/frames3'
VideoToFrames(pathIn, pathOut,
             initial_extract_time=1,
             end_extract_time=3,
             extract_time_interval = 0.5)   

pathOut = '../data/Real/frames4/'
VideoToFrames(pathIn, pathOut, extract_time_points=(0.3, 2), isColor = False)


pathOut = '../data/Real/frames5/'
VideoToFrames(pathIn, pathOut, extract_time_points=(0.3, 2), jpg_quality=50)
